    ...
    public static class Video implements Serializable {
        ...
        public static class UrlsBean implements Serializable {
            ...
            public static class FlagUrlsInfo implements Serializable {
                ...
                public String urls;
                public List<NameUrlBean> nameUrlBeans;

                public static class NameUrlBean implements Serializable {
                    public String name;
                    public String url;

                    public NameUrlBean(String name, String url) {
                        this.name = name;
                        this.url = url;
                    }
                }
