...
public class VideoView<P extends AbstractPlayer> extends FrameLayout implements MediaPlayerControl, AbstractPlayer.PlayerEventListener {
    ...
    protected FrameLayout mPlayerContainer;  //真正承载播放器视图的容器
    ...
    protected String mInfo;//当前播放视频的信息
    ...
    protected boolean mEnableAudioFocus; // 监听系统中音频焦点改变，见{@link #setEnableAudioFocus(boolean)}
    @Nullable
    protected AudioFocusHelper mAudioFocusHelper;
    protected List<OnStateChangeListener> mOnStateChangeListeners; // OnStateChangeListener集合，保存了所有开发者设置的监听器

    @Nullable
    protected ProgressManager mProgressManager; //进度管理器，设置之后播放器会记录播放进度，以便下次播放恢复进度

    protected boolean mIsLooping; //循环播放
    private int mPlayerBackgroundColor; //背景色，默认黑色
    ...
    public void onPrepared() {
        ...
        PrintUtil.saveSuccess(mInfo, System.currentTimeMillis()-beginTime);
        PrintUtil.printSuccessMap();
     ...
     * 设置控制器，传null表示移除控制器
     */
    public void addControlView(@Nullable BaseVideoController mediaController) {
